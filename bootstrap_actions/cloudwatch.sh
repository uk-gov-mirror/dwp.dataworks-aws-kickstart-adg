    ...
    "logs_collected": {
      "files": {
        "collect_list": [
          ...
          {
            "file_path": "/var/log/kickstart_adg/acm-cert-retriever.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "acm-cert-retriever.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/kickstart_adg/nohup.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "nohup.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/kickstart_adg/install-pycrypto.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "install-pycrypto.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/kickstart_adg/install-requests.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
            "log_stream_name": "install-requests.log",
            "timezone": "UTC"
          },
          {
            "file_path": "/var/log/kickstart_adg/install-boto3.log",
            "log_group_name": "$${cwa_bootstrap_loggrp_name}",
